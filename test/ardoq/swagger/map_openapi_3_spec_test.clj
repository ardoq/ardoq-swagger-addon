...
(deftest transform-schema-object-test
  (let [schema-object-spec (read-spec "schema-object-spec.yaml")
        data (map-openapi-3-spec/transform-objects initial-data map-openapi-3-spec/transform-schema-object schema-object-spec "#/components/schemas" :OpenAPI-Schema)]
